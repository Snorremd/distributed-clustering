...
def main():
    ...
    chromosome = Chromosome((2, 0.48, 0.72), 500, 7, 1, 3, 3, 0, 1,
                            {"FrontPageHeading": 1,
    ...
    write_to_file("resultsOptimalParamsModified.txt", results.results_string)
    detailed_results = "\n__________________________________________________________".join(results.clusters_result_strings)
    append_to_file("resultsOptimalParamsModified.txt", detailed_results)
