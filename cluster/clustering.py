...
## Import project modules/functions
import __main__
...
from geneticalgorithm.chromosome import MINTERMOCCURRENCEINCOLLECTION
...
class CompactTrieClusterer(object):
    ...
    def __init__(self, corpus, clusterSettings):
        ...
        self.logger.debug("Corpus path: %s".format(self.corpusPath))
    ...
    def get_corpus_path(self, corpus):
        ...
        return os.path.join(pathToMain, "corpora",
    ...
    def cluster(self, chromosome):
        ...
        snippetCollection = self.snippetCollection
